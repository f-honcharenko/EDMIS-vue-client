...
<div>
    <b-form @submit.prevent="">
      ...
      <b-form-group id="input-group-2" label="Last Name:" label-for="input-21">
        <b-form-input
          id="input-21"
          v-model="form.lname"
          placeholder="Enter name"
...
export default {
  ...
  methods: {
    submitForm(){
      ...
      axios.post(this.$nodeLink+'/api/user/updateOther', {token:localStorage['token'],fname:this.form.fname, lname:this.form.lname, login:this.form.login })
      .then((res)=>{
